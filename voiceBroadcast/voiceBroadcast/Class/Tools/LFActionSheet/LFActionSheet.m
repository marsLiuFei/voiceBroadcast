...
//            
//            cancelBtn.layer.cornerRadius  = cancelBtn.frame.size.height;
...
- (void)setOtherActionItemAlignment:(LFOtherActionItemAlignment)otherActionItemAlignment {
    
    _otherActionItemAlignment = otherActionItemAlignment;
    
    switch (otherActionItemAlignment) {
        case LFOtherActionItemAlignmentLeft:
        {
        ...
        case LFOtherActionItemAlignmentCenter:
        {
            for (UIView *actionItem in self.otherActionItems) {
                UILabel *title = [actionItem viewWithTag:1];
                title.textAlignment = NSTextAlignmentCenter;
